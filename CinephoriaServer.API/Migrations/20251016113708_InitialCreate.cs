        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasApprovedTermsOfUse = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Director = table.Column<List<string>>(type: "text[]", nullable: false),
                    ...
                    PosterUrls = table.Column<string>(type: "text", nullable: true),
                    BandeAnnonce = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectionQuality = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EmployeeFavoriteId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeFavorites", x => x.EmployeeFavoriteId);
                    table.ForeignKey(
                        name: "FK_EmployeeFavorites_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeFavorites_Movies_MovieId",
                        column: x => x.MovieId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MovieSimilarId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    SourceMovieId = table.Column<int>(type: "integer", nullable: false),
                    SimilarMovieId = table.Column<int>(type: "integer", nullable: false),
                    SimilarityScore = table.Column<double>(type: "double precision", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieSimilars", x => x.MovieSimilarId);
                    table.ForeignKey(
                        name: "FK_MovieSimilars_Movies_SimilarMovieId",
                        column: x => x.SimilarMovieId,
                        principalTable: "Movies",
                        principalColumn: "MovieId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieSimilars_Movies_SourceMovieId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserFavoriteId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    AppUserId = table.Column<string>(type: "text", nullable: false),
                    MovieId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserMovieHistoryId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    AppUserId = table.Column<string>(type: "text", nullable: false),
                    MovieId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserMovieHistories", x => x.UserMovieHistoryId);
                    table.ForeignKey(
                        name: "FK_UserMovieHistories_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Incidents_Theaters_TheaterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeatReservations", x => new { x.ReservationsReservationId, x.SeatsSeatId });
                    table.ForeignKey(
                        name: "FK_SeatReservations_Reservations_ReservationsReservationId",
                        column: x => x.ReservationsReservationId,
                        principalTable: "Reservations",
                        principalColumn: "ReservationId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SeatReservations_Seats_SeatsSeatId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeFavorites_AppUserId_MovieId",
                table: "EmployeeFavorites",
                columns: new[] { "AppUserId", "MovieId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeFavorites_MovieId",
                table: "EmployeeFavorites",
                column: "MovieId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieSimilars_SimilarMovieId",
                table: "MovieSimilars",
                column: "SimilarMovieId");

            migrationBuilder.CreateIndex(
                name: "IX_MovieSimilars_SourceMovieId_SimilarMovieId",
                table: "MovieSimilars",
                columns: new[] { "SourceMovieId", "SimilarMovieId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeatReservations_SeatsSeatId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFavorites_AppUserId_MovieId",
                table: "UserFavorites",
                columns: new[] { "AppUserId", "MovieId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserMovieHistories_AppUserId_MovieId",
